...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,         KC_1,               KC_2,               KC_3,               KC_4,               KC_5,           TG(6),                                          TG(5),          KC_6,           KC_7,               KC_8,               KC_9,               KC_0,               KC_BSPACE,
    KC_TAB,            KC_Q,               KC_D,               KC_R,               KC_W,               KC_B,           KC_CAPSLOCK,                                    KC_DELETE,      KC_J,           KC_F,               KC_U,               KC_P,               KC_SCOLON,          KC_BSLASH,
    LCTL_T(KC_ESCAPE), MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_S), MT(MOD_LSFT ,KC_H), MT(MOD_LCTL, KC_T), KC_G,                                                                           KC_Y,           MT(MOD_RCTL, KC_N), MT(MOD_RSTF, KC_E), MT(MOD_LALT, KC_O), MT(MOD_RGUI, KC_I), RCTL_T(KC_QUOTE),
